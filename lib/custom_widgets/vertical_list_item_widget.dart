...
class VerticalListItemBuilder<T> extends StatelessWidget {
  VerticalListItemBuilder({Key key,@required this.snapshot,@required this.itemBuilder}) : super(key: key);
  ...
  Widget _buildList(List<T> items,BuildContext context){
    return ListView.separated(
      shrinkWrap: true,
        ...
        itemBuilder: (context, index) { if(index==0||index==items.length+1){
          return Container();
        }
